...
<head>
    ...
    <meta charset="utf-8" />
    <title>Registration Successful | EduGenesis</title>
                        ...
                        <div class="card mt-4 card-bg-fill">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted mx-4">Your account has been created successfully. You can now sign in and start using our services.</p>
                                    <div class="mt-4">
                                        <a href="http://localhost/project" class="btn btn-primary w-100">Sign In</a>
                                    </div>
                                </div>
                            </div>
                        </div>
