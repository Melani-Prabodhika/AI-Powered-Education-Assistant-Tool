...
<body>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2">
                                    <form id="pw_frm">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="cpassword-input">Confirm Password</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Confirm password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="cpassword-input" name="cpassword-input" required>
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none" type="button" id="cpassword-input"><i class="ri-eye-fill align-middle"></i></button>
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		const cpasswordInput = document.getElementById("cpassword-input");
	...
	$(document).ready(function() {
		$('#pw_frm').ajax_submit({
			...
			callback : function(response){
				if (response !== "") {
					window.location.href = "/Login/resetpw_success";
				}
			}
		});
	});
